...
///
/// @tparam T data type
template <typename T> class MyArrayQueue : public MyQueue<T> {
private:
  T *array;
...
public:
  /// @brief Constructs an array queue instance with a specified initial
  /// capacity.
  ///
  ...
  /// @brief Constructs an array queue instance with a default initial capacity
  /// of 16.
  MyArrayQueue() : MyArrayQueue(defaultCapacity) {};

  /// @brief Constructs an array queue instance with the copied contents of
  /// another array queue.
  ///
  ...
  /// @brief Reinitalizes assignee (left hand side) array queue instance from
  /// another array queue.
  ///
  /// @param queue other array queue to deep copy from
  ...
  virtual ~MyArrayQueue() { delete[] array; }
  ...
  /// @brief Retrieves, but does not remove, the element at the front of this
  /// queue.
  ///
  ...
  /// @brief Returns a string representation of this queue, e.g. "[element1,
...
/// @brief Prints out the array queue without needing to manually call
/// toString().
///
/// @tparam T data type
/// @param str ostream
