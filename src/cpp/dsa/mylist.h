...
/// @brief Abstract class (used as an interface) which defines methods for
/// lists.
///
/// @tparam T data type
...
public:
  ...
  virtual std::expected<void, std::string> add(unsigned int index,
                                               const T &element) = 0;
  ...
  virtual std::expected<T, std::string> set(unsigned int index,
                                            const T &element) = 0;
