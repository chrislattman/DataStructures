...
public:
  ...
  /// @brief Constructs a stack instance with the copied contents of another
  /// stack.
  ///
  ...
  /// @brief Reinitalizes assignee (left hand side) stack instance from another
  /// stack.
  ///
  /// @param stack other stack to deep copy from
  ...
  /// @brief Retrieves, but does not remove, the element at the top of this
  /// stack.
  ///
  ...
  /// @brief Returns a string representation of this stack, e.g. "[element1,
