...
public interface MyMap<K, V> {
     ...
     *
     * Note: the Java API provides a different method called keySet() which returns a set of the keys.
     *
    ...
    /**
     * Inserts a key-value pair into this map only if key was not found. Null keys and null values are not permitted.
     *
     * @param key key to add
     * @param value value associated with key
    ...
    /**
     * Replaces the value for a key with another value. Null values are not permitted.
     *
